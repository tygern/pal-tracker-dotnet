...
namespace PalTrackerTests
{
    public class InMemoryTimeEntryRepositoryTest
    {
        ...
        public void Create()
        {
            ...
            var created = _repository.Create(new TimeEntry(222, 333, Convert.ToDateTime("01/08/2008 12:00:01"), 24));
        ...
        public void Find()
        {
            ...
            Assert.Equal(new TimeEntry(1, 222, 333, Convert.ToDateTime("01/08/2008 12:00:01"), 24), found);
        }
        ...
        public void List()
        {
            ...
            Assert.Contains(new TimeEntry(2, 888, 777, Convert.ToDateTime("02/09/2012 11:30:00"), 12), found);
            Assert.Contains(new TimeEntry(1, 222, 333, Convert.ToDateTime("01/08/2008 12:00:01"), 24), found);
        ...
        public void Update()
        {
            ...
            _repository.Update(1, new TimeEntry(555, 666, Convert.ToDateTime("01/08/2020 01:55:10"), 8));

            var entires = _repository.List();
            Assert.Contains(new TimeEntry(1, 555, 666, Convert.ToDateTime("01/08/2020 01:55:10"), 8), entires);
            Assert.DoesNotContain(new TimeEntry(1, 222, 333, Convert.ToDateTime("01/08/2008 12:00:01"), 24), entires);
        }
